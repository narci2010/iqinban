...
<template>
  <div class="i-content is-menubar is-tabbar">
    ...
    <i-card title="学生">
      <div slot="button">
        <el-button size="mini" class="i-button__ctrl i-button__ctrl-mini i-button__primary">新增学生</el-button>
    ...
    <i-card title="课程">
      <div slot="button">
        <el-button size="mini" class="i-button__ctrl i-button__ctrl-mini i-button__primary">创建课程</el-button>
        <el-button size="mini" class="i-button__ctrl i-button__ctrl-mini i-button__primary-text">显示全部</el-button>
      </div>
      <div slot="body">
        <el-row :gutter="20">
          <el-col v-for="i in 4" :key="i" :span="6">
            <div class="card__item-b">
              ...
              <el-popover
                ...
                popper-class="i-popover i-popover__small">
                <div class="i-popover__content i-popover__content-small">
                  <a class="i-popover__item" href="javascript:">进入学生主页</a>
                  <a class="i-popover__item" href="javascript:">删除课程</a>
                </div>
                <a href="javascript:" slot="reference" class="card__more"><i class="iconfont icon-morecopy_px"></i></a>
              </el-popover>
            </div>
