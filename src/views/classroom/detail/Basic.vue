...
<template>
  <div class="i-student-basic">
    ...
    <el-dialog
      ...
      <div class="i-dialog-title">班级初始化/编辑班级信息</div>
      <el-form :model="form" label-position="top" style="width:550px;margin:0 auto;">
        ...
        <el-form-item label="当前课程等级" label-width="80px" class="i-form-item">
          <el-input placeholder="教材名1（默认）"></el-input>
          <el-button>新增教材</el-button>
        </el-form-item>
        ...
        <el-form-item>
          <el-row :gutter="50" style="margin-top: 35px;margin-bottom: 30px">
            <el-col :span="12">
...
<script>
  ...
  import basic from '../../../mock/classroom/basic'
