  ...
  <div class="i-student-detail">
    <div class="i-secondary-menu">
      <i-tab :active-index="activeIndex">
        <i-tab-item :index="1">
          <router-link to="/student/detail">学习记录</router-link>
        </i-tab-item>
        <i-tab-item :index="2">
          <router-link to="/student/detail/basic">基本信息统计</router-link>
        </i-tab-item>
        <i-tab-item :index="3">
          <router-link to="/student/detail/plan">教学计划</router-link>
        </i-tab-item>
        <i-tab-item :index="4">
          <router-link to="/student/detail/doc">文档</router-link>
        </i-tab-item>
      </i-tab>
      <i-secondary title="某某某" sup="学生" :show="show">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      show () {
        return this.$route.path === '/student/detail'
      }
    },
    data () {
      return {
